...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='traffic-revin-dct-sgconv', help='model id')
    parser.add_argument('--model', type=str,  default='SRDformer',
                        help='model name, options: [SRDformer]')
    ...
    parser.add_argument('--freq', type=str, default='h',
                        help='freq for time features en0.299coding, options:[s:secondly, t:minutely, h:hourly, d:daily, b:business days, w:weekly, m:monthly], you can also use more detailed freq like 15min or 3h')
